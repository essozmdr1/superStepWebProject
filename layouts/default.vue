...
import Container2Vue from '../components/Container2.vue';
import FooterVue from '../components/Footer.vue'
import SliderVue from '../components/Slider.vue';
import Container3Vue from '../components/Container3.vue';
...
export default {
    name: "IndexPage",
    components: { Navbar, SezonunTrendleriVue, ContainerVue, KoleksiyonlarVue, Container2Vue, FooterVue, SliderVue, Container3Vue, Footer2Vue, FavoriModellerSliderVue, OneCikanlarSliderVue, Container4Vue }
}
</script>